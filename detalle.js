...
class MovieDetail {
    ...
    displayMovie() {
        ...
        ratingElement.innerHTML = '★'.repeat(this.movie.rating) + '☆'.repeat(5 - this.movie.rating);
    ...
    prepareEditForm() {
        ...
        // Mostrar imagen actual en vista previa de edición
        if (this.movie.poster) {
    ...
    showReadView() {
        ...
        this.prepareEditForm(); // Resetear formulario a datos actuales
    }
    ...
    setEditRating(rating) {
        ...
        document.querySelectorAll('#editStars .star').forEach((star, index) => {
            if (index < rating) {
